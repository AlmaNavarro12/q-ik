...
function obtenerDatosPermisos()
{
    ...
    $p->setEditarcot($_POST['editarcot']);
    $p->setEliminarcot($_POST['eliminarcot']);
    $p->setListacotizacion($_POST['listacotizacion']);
    $p->setAnticipo($_POST['anticipo']);
    $p->setCliente($_POST['cliente']);
    $p->setCrearcarta($_POST['crearcat']);
    $p->setEditarcarta($_POST['editarcat']);
    $p->setEliminarcarta($_POST['eliminarcat']);
    $p->setListacarta($_POST['listacat']);
    ...
    $p->setAsignarpermisos($_POST['asigpermiso']);
    ...
    $p->setEditfolio($_POST['editfolio']);
