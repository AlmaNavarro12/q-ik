...
class ControladorPermiso {
    ...
    public function getPermisos() {
        ...
        foreach ($this->getPermisoById() as $usuarioactual) {
            ...
            $fields = ['facturas', 'pago', 'nomina', 'listaempleado', 'listanomina', 'cartaporte', 'listaubicacion', 'listatransporte', 'listaremolque', 'listaoperador', 'listacarta', 'cotizacion', 'cliente', 'listacliente', 'comunicado', 'producto', 'proveedor', 'impuesto', 'datosfacturacion', 'contrato', 'listausuario', 'reporte', 'reportefactura', 'reportepago', 'reportegrafica', 'reporteiva', 'datosiva', 'reporteventa', 'configuracion', 'ventas', 'crearventa', 'listaventa', 'acceso', 'imgperfil'];
