    ...
    <div class="div-form  p-5 border border-secondary-subtle">
            ...
            <div class="row">
                <div class="col-md-4 py-1">
                    <div class="new-tooltip icon tip">
                        <label class="label-form text-right mb-2" for="nombre-cliente">Cliente</label><label class="mark-required text-danger fw-bold">*</label> <span class="fas fa-question-circle"></span>
        ...
        <div class="row">
            <div class="d-flex justify-content-end mt-3">
                ...
                <button class="button-form btn btn-primary " onclick="insertarFactura()" id="btn-form-factura">Guardar <span class="fas fa-save"></span></button>
            </div>
        </div>
    </div>
    </form>
