        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" onsubmit="return false;">
                    <div class="row">
                        <div class="col-sm-6">
                            <input type="text" class="form-control inp-mod" id="buscar-producto" placeholder="Buscar Productos (Codigo, Nombre, Clv o Descripcion Fiscal del producto)" oninput="buscarProducto()">
                        </div>
                        <div class="col-sm-2">
...
<div class="modal fade" id="modal-cantidad" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <button type="button" class="close-modal" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div class="titulo-modal" id="contenedor-cant-title">Editar</div>
            <div class="modal-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-producto" onsubmit="return false;">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button class="button-modal" onclick="insertarProductoCarta()" id="btn-form-producto-factura">Guardar <span class="glyphicon glyphicon-floppy-disk"></span></button>
                        </div>
                    </div>
                </form>
            </div>
