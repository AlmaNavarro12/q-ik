    ...
    <div class="row d-flex justify-content-between">
        <div class="col-12 col-md py-1">
            <button id="btn-nuevo-producto" type="button" class="button-ventas col-12" onclick="newVenta();">
                <span class="fas fa-plus"></span> Nuevo ticket (F1)
            </button>
        </div>
        ...
        <div class="col-12 col-md py-1" id="div-entradas" hidden="">
            <button id="btn-entrada" type="button" class="button-ventas col-12" data-bs-toggle="modal" data-bs-target="#modal-entradas" onclick="setLabelIngreso(this)">
                <span class="fas fa-dollar-sign"></span> Registrar Entrada (F2)
            </button>
        </div>
        ...
        <div class="col-12 col-md py-1">
            <button id="btn-form-factura" type="button" class="button-ventas col-12" style="background-color: #327AB7 !important; color: #fff !important;" data-bs-toggle="modal" data-bs-target="#modal-cobrar" onclick="setValoresCobrar();">
                <span class="fas fa-save"></span> Cobrar ticket (F7)
            </button>
        </div>
    </div>
