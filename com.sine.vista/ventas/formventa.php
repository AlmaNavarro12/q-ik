...
<div class='container'>
    ...
    <div class="div-form mt-3 p-5 border border-secondary-subtle">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-12 py-1">
                <button id="btn-form-factura" type="button" class="button-modal col-12" style="background-color: #327AB7 !important; color: #fff !important;" data-bs-toggle="modal" data-bs-target="#modal-cobrar" onclick="setValoresCobrar();">
                    <span class="fas fa-save"></span> Cobrar <br> ticket (F7)
                </button>
            </div>
        </div>
        <br />
        <div class="col-12 scrollX" style="max-width: 100%;">
            <div class="col-md-12">
