        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" onsubmit="return false;">
                    <div class="row">
                        <div class="col-sm-7">
                            <input type="text" class="form-control inp-mod" id="buscar-producto" placeholder="Buscar productos (Código, Nombre, Clave o Descripción fiscal del producto)" oninput="filtrarProducto()">
                        </div>
                        <div class="col-sm-2">
                            <select class="form-select inp-mod" id="num-reg" name="num-reg" onchange="filtrarProducto()">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea rows="9" cols="60" id="observaciones-producto" class="form-control input-form mb-2" placeholder="Observaciones sobre el Producto" maxlength="10000"></textarea>
...
<!--AGREGAR PRODUCTO DESDE FACTURAS-->
                    ...
                    <div class="row">
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-md-6 text-end">
                                <button class="button-modal" onclick="insertarProductoCot()" id="btn-form-producto-factura">Guardar producto <span class="fas fa-save"></span></button>
                            </div>
                        </div>
                    </div>
            </div>
                            ...
                            <table class="table tab-hover table-condensed table-responsive table-row table-head">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <button class="button-modal col-12" onclick="actualizarConceptoCotizacion()" id="btn-form-producto-editar">Guardar <span class="fas fa-save"></span></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
