...
$pdf->SetWidths(Array(25, 25, 25, 25, 25, 25, 22, 26));
$pdf->SetLineHeight(5);
$pdf->RoundedRect(10, $pdf->GetY(), 195, 5, 2, 'FD');
$pdf->RowNBC(Array(iconv("utf-8", "windows-1252","Folio") ,"Facturas Pagadas","Emisor","Cliente", "RFC Cliente", "Forma de pago", "Fecha de Pago", "Total Pago"));
...
foreach ($pagos as $reporteactual) {
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->Row(Array($folio, $cfdis, iconv("utf-8", "windows-1252",$emisor), iconv("utf-8", "windows-1252",$nombre_cliente), iconv("utf-8", "windows-1252",$rfc), iconv("utf-8", "windows-1252",$formapago), iconv("utf-8", "windows-1252","$fechapago - $horapago"), iconv("utf-8", "windows-1252",'$ ' . number_format($total, 2, '.', ',').' '.$cmoneda)));
}
...
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(35, 8, iconv("utf-8", "windows-1252",'$ ' . number_format($totalpagado, 2, '.', ',')), 1, 0, 'C', 0);
